...
<template>
    <div>
        <h2 class="content-block">Without Cell Template</h2>
        <div class="container">
            <DxDataGrid class="dx-card wide-card" :data-source="dataSourceConfig" :key-expr="'id'" :show-borders="false"
                ...
                <DxColumn data-field="include" caption="Include" :hiding-priority="8" :width="includeWidth" />
                ...
                <DxColumn data-field="lastViewed" caption="Last Viewed" :hiding-priority="9" />
                ...
                <DxColumn data-field="totalPositiveFeedback" caption="Positive Feedback" :hiding-priority="4"
                    width="85px" />
                <DxColumn data-field="totalNegativeFeedback" caption="Negative Feedback" :hiding-priority="3"
                    width="85px" />
